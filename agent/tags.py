...
TAG_BLOCK_INJECT_BEGIN = "block.inject.begin"
TAG_BLOCK_INJECT_END = "block.inject.end"
TAG_INJECT_BEGIN = "inject.begin"
TAG_INJECT_END = "inject.end"

TAG_BLOCK_INJECT_BEGIN_LEN = len(TAG_BLOCK_INJECT_BEGIN)
TAG_BLOCK_INJECT_END_LEN = len(TAG_BLOCK_INJECT_END)
